...
public class PruebaSombreroVagabundo : MonoBehaviour, ISombreros
{
    ...
    public void Shoot()
    {
        ...
        switch (hatDir)
        {
            case Direction.UP:
                ...
                pAnimator.Play("Hat_Homeless_Up");
